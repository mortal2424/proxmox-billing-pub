...
--
-- Хост: localhost:3306
-- Время создания: Июн 17 2026 г., 01:00
...
INSERT INTO `features` (`id`, `title`, `description`, `icon`, `is_active`, `created_at`, `sort_order`, `updated_at`) VALUES
(1, 'Автоматическое масштабирование', 'Увеличивайте ресурсы вашего сервера в один клик', 'fas fa-expand', 1, '2025-04-08 06:16:37', 0, '2025-12-13 06:23:26'),
(2, 'Ежедневные бэкапы', 'Автоматическое резервное копирование данных каждый день', 'fas fa-database', 1, '2025-04-08 06:16:37', 0, '2025-12-13 06:23:26'),
(3, 'Круглосуточная поддержка', 'Наша команда поддержки доступна 24/7', 'fas fa-headset', 1, '2025-04-08 06:16:37', 0, '2025-12-13 06:23:26'),
(4, 'DDoS защита', 'Защита от распределенных атак любого уровня', 'fas fa-shield-alt', 1, '2025-04-08 06:16:37', 0, '2025-12-13 06:23:26'),
(5, 'Быстрое развертывание', 'Новый сервер за 60 секунд', 'fas fa-rocket', 1, '2025-04-08 06:16:37', 0, '2025-12-13 06:23:26'),
(6, 'Гибкая тарификация', 'Оплачивайте только используемые ресурсы', 'fas fa-calculator', 1, '2025-04-08 06:16:37', 0, '2025-12-13 06:23:26');
...
INSERT INTO `promotions` (`id`, `title`, `description`, `image`, `is_active`, `start_date`, `end_date`, `created_at`, `sort_order`, `updated_at`) VALUES
(1, 'Скидка 10% новым клиентам', 'Закажите любой тариф и получите скидку 10% на первый месяц', 'https://avatars.mds.yandex.net/i?id=72f879f2b6016f5d572ed5aed474d7c11fe4eba8-9246177-images-thumbs&n=13', 1, '2025-04-12', '2025-12-30', '2025-04-08 06:16:37', 0, '2025-12-16 03:54:47'),
(2, 'Бесплатный перенос сервера', 'Переносим ваш сервер от другого провайдера бесплатно', 'https://sovross.ru/wp-content/uploads/2025/01/unnamed-1.png', 1, '2025-04-12', '2025-12-30', '2025-04-08 06:16:37', 0, '2025-12-13 06:23:26'),
(3, '2 месяца в подарок', 'При оплате годового тарифа получите 2 дополнительных месяца', 'https://avatars.mds.yandex.net/get-tycoon/10238194/2a0000018f3de51bbdb2b48e77a92995e0b2/priority-promotion', 1, '2025-04-12', '2025-12-30', '2025-04-08 06:16:37', 0, '2025-12-13 06:23:26'),
(5, 'test', 'test', '', 1, '2025-12-17', '2025-12-18', '2025-12-17 02:18:45', 0, '2025-12-17 02:18:45');
...
(1, 0.900000, 0.000300, 0.013500, '2025-12-17 01:27:04', 0.450800, 0.000158, 0.000030);
...
(6, '2.5.1-beta4', '2026-06-10', '', '2026-06-10 03:52:39');
