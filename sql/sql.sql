...
--
-- Хост: localhost:3306
-- Время создания: Дек 09 2025 г., 12:52
...
(1, 'Автоматическое масштабирование', 'Увеличивайте ресурсы вашего сервера в один клик', 'fas fa-expand', 1, '2025-04-08 06:16:37'),
(2, 'Ежедневные бэкапы', 'Автоматическое резервное копирование данных каждый день', 'fas fa-database', 1, '2025-04-08 06:16:37'),
(3, 'Круглосуточная поддержка', 'Наша команда поддержки доступна 24/7', 'fas fa-headset', 1, '2025-04-08 06:16:37'),
(4, 'DDoS защита', 'Защита от распределенных атак любого уровня', 'fas fa-shield-alt', 1, '2025-04-08 06:16:37'),
(5, 'Быстрое развертывание', 'Новый сервер за 60 секунд', 'fas fa-rocket', 1, '2025-04-08 06:16:37'),
(6, 'Гибкая тарификация', 'Оплачивайте только используемые ресурсы', 'fas fa-calculator', 1, '2025-04-08 06:16:37');
...
INSERT INTO `promotions` (`id`, `title`, `description`, `image`, `is_active`, `start_date`, `end_date`, `created_at`) VALUES
(1, 'Скидка 10% новым клиентам', 'Закажите любой тариф и получите скидку 10% на первый месяц', 'https://avatars.mds.yandex.net/i?id=72f879f2b6016f5d572ed5aed474d7c11fe4eba8-9246177-images-thumbs&n=13', 1, '2025-04-12', '2025-04-30', '2025-04-08 06:16:37'),
(2, 'Бесплатный перенос сервера', 'Переносим ваш сервер от другого провайдера бесплатно', 'https://sovross.ru/wp-content/uploads/2025/01/unnamed-1.png', 1, '2025-04-12', '2025-04-30', '2025-04-08 06:16:37'),
(3, '2 месяца в подарок', 'При оплате годового тарифа получите 2 дополнительных месяца', 'https://avatars.mds.yandex.net/get-tycoon/10238194/2a0000018f3de51bbdb2b48e77a92995e0b2/priority-promotion', 1, '2025-04-12', '2025-04-30', '2025-04-08 06:16:37');
...
--
-- Дамп данных таблицы `user_quotas`
--

INSERT INTO `user_quotas` (`id`, `user_id`, `max_vms`, `max_cpu`, `max_ram`, `max_disk`, `created_at`, `updated_at`) VALUES
(5, 1, 11, 16, 32768, 300, '2025-04-12 10:47:23', '2025-04-13 08:28:51');
